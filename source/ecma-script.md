title: ECMAScript
permalink: ecma-script/
---

This is intended as a quick reference for what you can use as JavaScript features.

## The best support for ES6 out there

Using [Babel](https://babeljs.io/), we provide the best support for ES6 on the market, in terms of variaty of availble language features.
...
[Check the current coverage of ES6 by Babel.js](https://kangax.github.io/compat-table/es6/#babel).
...
{% note info __proto__ support comes from the JavaScript engine running your program %}
Although most support the now standard property, [some do not](http://kangax.github.io/compat-table/es6/#__proto___in_object_literals).
{% endnote %}
...
{% note warn Not available in Pagehop %}
...
{% note info Module Formatters %}
Babel can transpile ES6 Modules to several different formats including Common.js, AMD, System, and UMD. You can even create your own. For more details see the [modules docs](https://bablejs.io/docs/usage/modules) on Babel's website.
{% endnote %}
...
{% note warn Additional polyfill needed %}
...
{% note warn Using Module Loader %}
In order to use this, you'll need to tell babel to use the <code>system</code> module formatter. Also be sure to check out [System.js](https://github.com/systemjs/systemjs).
{% endnote %}
...
{% note warn Limited support from polyfill %}
Most of these APIs are supported by the babel polyfill. However, certain features are omitted for various reasons (e.g. <code>String.prototype.normalize</code> needs a lot of additional code to support). You can find more polyfills [here](https://github.com/addyosmani/es6-tools#polyfills).
{% endnote %}
...
{% note warn Only supports literal form %}
